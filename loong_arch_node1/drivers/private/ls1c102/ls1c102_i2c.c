...
void I2C_AcknowledgeConfig(I2C_TypeDef* I2Cx, FunctionalState NewState)
{
    ...
    if (NewState == DISABLE)
    {
        ...
        I2Cx->CR_SR |= I2C_NACK_Set;
    }
    else
    {
        /* Enable the acknowledgement */
        I2Cx->CR_SR &= I2C_NACK_Reset;
    }
}
...
/**
  ...
  */
void I2C_ReceiveData(I2C_TypeDef* I2Cx, uint8_t ACK, uint8_t STOP)
{
    I2C_Unlock(I2Cx);
...
uint8_t CAT24_Read_Int(uint16_t Raddr)
{
    ...
    STS=0;
    I2C_ReceiveData(I2C,I2C_NACK_Set,I2C_STOP_Set);
    while(!STS)//等待数据接收完毕
    {
        delay_us(1);
    }
